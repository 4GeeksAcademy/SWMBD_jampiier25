...
Revision ID: 40a2a4f968b0
Revises: a5cffa318ac2
Create Date: 2025-04-10 16:32:52.650213
...
def upgrade():
    ...
    sa.Column('favorite_type', sa.Enum('character', 'planet', 'vehicle', name='favoritetype'), nullable=False),
